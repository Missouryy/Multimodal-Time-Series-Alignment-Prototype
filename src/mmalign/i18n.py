...
LANGS = {
    "English": {
        ...
        "sidebar.header": "Manage and align multimodal streams",
        ...
        "streams.overlay_with": "Overlay with (optional)",
        ...
        "method.xcorr": "Cross-correlation (lag)",
        "method.dtw": "DTW",
        ...
        "db.not_connected": "Database: not connected (optional)",
